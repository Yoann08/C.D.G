...
<html lang="en">
    ...
    <div class="shadow-md shadow-purple-dark/[.7] py-10 mb-5">
        <!-- LOGO LANGAGE + BOUTON -->
        <div class="flex justify-end items-center mx-56">
            <img class="w-28 mr-72" src="assets/image/html.png" alt="">
            <div class="flex justify-center items-center">
                <button class="mr-2" id="dropdownFiltre" data-dropdown-toggle="dropdown">
        ...
        <!-- CARD LIST -->
        <div class="mx-52 my-10 md:w-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
            <div class="mx-auto h-72 rounded-lg shadow-md shadow-purple-light my-4">
                <a href="content/produit.php">
                    <img class="rounded-lg h-72 w-60" src="assets/image/2.png" alt=""/>
                </a>
            </div>
            <div class="mx-auto h-72 rounded-lg shadow-md shadow-purple-light my-4">
                <img class="rounded-lg h-72 w-60" src="assets/image/3.png" alt=""/>
            </div>
            <div class="mx-auto h-72 rounded-lg shadow-md shadow-purple-light my-4">
                <img class="rounded-lg h-72 w-60" src="assets/image/4.png" alt=""/>
            </div>
            <div class="mx-auto h-72 rounded-lg shadow-md shadow-purple-light my-4">
                <img class="rounded-lg h-72 w-60" src="assets/image/5.png" alt=""/>
            </div>
            <div class="mx-auto h-72 rounded-lg shadow-md shadow-purple-light my-4">
                <img class="rounded-lg h-72 w-60" src="assets/image/3.png" alt=""/>
            </div>
